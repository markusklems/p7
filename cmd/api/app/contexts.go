...
func NewCodeLambdaContext(ctx context.Context, service *goa.Service) (*CodeLambdaContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewCreateLambdaContext(ctx context.Context, service *goa.Service) (*CreateLambdaContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewDeleteLambdaContext(ctx context.Context, service *goa.Service) (*DeleteLambdaContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewListLambdaContext(ctx context.Context, service *goa.Service) (*ListLambdaContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewShowLambdaContext(ctx context.Context, service *goa.Service) (*ShowLambdaContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewUpdateLambdaContext(ctx context.Context, service *goa.Service) (*UpdateLambdaContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewWatchLambdaContext(ctx context.Context, service *goa.Service) (*WatchLambdaContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
