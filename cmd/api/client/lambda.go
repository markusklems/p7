...
// RunLambdaPath computes a request path to the run action of lambda.
func RunLambdaPath(lambdaID int) string {
	param0 := strconv.Itoa(lambdaID)

	return fmt.Sprintf("/p7/lambdas/%s/actions/run", param0)
}

// RunLambdaPath2 computes a request path to the run action of lambda.
func RunLambdaPath2(lambdaID int) string {
	param0 := strconv.Itoa(lambdaID)

	return fmt.Sprintf("/p7/lambdas/%s/actions/run", param0)
}

// RunLambdaPath3 computes a request path to the run action of lambda.
func RunLambdaPath3(lambdaID int) string {
	param0 := strconv.Itoa(lambdaID)

	return fmt.Sprintf("/p7/lambdas/%s/actions/run", param0)
}

// RunLambdaPath4 computes a request path to the run action of lambda.
func RunLambdaPath4(lambdaID int) string {
	param0 := strconv.Itoa(lambdaID)

	return fmt.Sprintf("/p7/lambdas/%s/actions/run", param0)
}

// RunLambda makes a request to the run action endpoint of the lambda resource
...
// NewRunLambdaRequest create the request corresponding to the run action endpoint of the lambda resource.
