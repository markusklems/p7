...
import (
	...
	"github.com/markusklems/p7/cmd/api/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "p7-cli",
		Short: `CLI client for the p7 service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "127.0.0.1:8888", "API hostname")
