...
func MountHealthController(service *goa.Service, ctrl HealthController) {
	...
	service.Mux.Handle("GET", "/image/health/check", ctrl.MuxHandler("check", h, nil))
	service.LogInfo("mount", "ctrl", "Health", "action", "Check", "route", "GET /image/health/check")
}
...
func MountImageController(service *goa.Service, ctrl ImageController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewCreateImageContext(ctx, req, service)
		if err != nil {
			return err
		}
		// Build the payload
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewDeleteImageContext(ctx, req, service)
		if err != nil {
			return err
		}
