...
func NewCreateImageContext(ctx context.Context, r *http.Request, service *goa.Service) (*CreateImageContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewDeleteImageContext(ctx context.Context, r *http.Request, service *goa.Service) (*DeleteImageContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
