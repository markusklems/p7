...
import (
	...
	"github.com/markusklems/p7/cmd/image/client"
	"github.com/markusklems/p7/cmd/image/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "image-cli",
		Short: `CLI client for the image service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:8890", "API hostname")
